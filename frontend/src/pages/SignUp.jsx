...
const SignUp = () => {
 ...
 return (
  <div className='w-full h-screen flex justify-center p-4 items-center relative'>
    
    {/* Back arrow to homepage */}
    <div className='absolute top-6 left-6 cursor-pointer text-gray-600 hover:text-black' onClick={() => navigate( "/")}>
      <FaArrowLeft size={24} />
    </div>
